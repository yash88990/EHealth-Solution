                              ...
                              children: ['Patient', 'Doctor'].map((String type) {
                                ...
                                return ChoiceChip(
                                  ...
                                  labelStyle: GoogleFonts.poppins(
                                    color: isSelected ? Colors.white : Color(0xff0064FA), 
                                  ),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(20.0), 
                                    side: BorderSide(
                                      color: isSelected ? Color(0xff0064FA) : Color(0xff0064FA), 
                                      width: 2.0, 
                                    ),
                                  ),
                      ...
                      SizedBox(
                        ...
                        child: DropdownButtonFormField<String>(
                          ...
                          items: [
                            ...
                            'Hyderabad', 'Pune', 'Ahmedabad', 'Jaipur', 'Lucknow', 'Others'
  ...
  if (_formKey.currentState!.validate()) {
    ...
    try {
      ...
      if (user != null) {
        ...
        await _database.child(userTypePath).child(user.uid).set(userData).then((_) {
          print("✅ Data stored successfully in $userTypePath!");
        }).catchError((error) {
